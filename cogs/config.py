"""
Config cog — /config set, /config get
...
class ConfigCog(commands.GroupCog, name="config"):
    ...
    @app_commands.command(name="set", description="[Staff] Set a bot config value")
    ...
    async def config_set(self, interaction: discord.Interaction, key: app_commands.Choice[str], value: str):
        ...
        await db.set_config(key.value, value)
    ...
    @app_commands.command(name="get", description="[Staff] View a bot config value")
    ...
    async def config_get(self, interaction: discord.Interaction, key: app_commands.Choice[str]):
        ...
        value = await db.get_config(key.value)
    ...
    @app_commands.command(name="list", description="[Staff] List all config keys and values")
